...
var Sheet = function (_a) {
    ...
    return React.createElement("div", { style: __assign({ overflowX: 'hidden', position: 'fixed', bottom: 0, left: 0, width: '100%', zIndex: 99, transition: "all 0.3s ease-in-out", backgroundColor: '#808080', transform: show ? "translate3d(0, 0, 0)" : "translate3d(0, 101%, 0)", borderTopLeftRadius: borderRadius, borderTopRightRadius: borderRadius }, style) }, children);
};
